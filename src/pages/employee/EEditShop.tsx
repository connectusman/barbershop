...
const EEditShop: React.FC<MyModalProps> = ({tempstr,shopM,custM,empM,bookM}) => {
...
<br></br>
    ...
    setimg(imgdata);
     ...
     <br></br>
    <IonButton onClick={e=>{hist.push("/ebbshopinfo")}} expand="full" ><IonText className="floatleft">{lang[44+tempstr[7]].Informations}</IonText><IonIcon className="floatright" icon={caretForwardOutline}></IonIcon></IonButton>
    <br></br>
