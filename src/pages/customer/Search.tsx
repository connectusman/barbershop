...
const Search: React.FC <MyModalProps> = ({tempstr,shopM,custM,empM,bookM}) => {
  let hist=useHistory();
  ...
  />
      <div className="dividerline"></div>
        ...
        <IonSearchbar ref={name} placeholder="Where (address, postal code..)" onIonChange={e => {}}></IonSearchbar>
