...
const MyAccord2: React.FC<any>=({title,data})=> {
  ...
  <IonRow >
    <IonButton onClick={()=>{
      ...
      const ddd=document.getElementById("accord2");
      let len=acc.length;
    ...
    }} id="accord2" className="accordion2"><IonText className="floatleft p-size4">{title}</IonText><IonIcon className="floatright" icon={isdown}></IonIcon></IonButton>
      
<IonList id="panel2" className="panel2">
